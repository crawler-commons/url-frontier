...
public class GetActive implements Runnable {
	...
	public void run() {
		...
		crawlercommons.urlfrontier.Urlfrontier.Empty.Builder builder = crawlercommons.urlfrontier.Urlfrontier.Empty
				.newBuilder();

		crawlercommons.urlfrontier.Urlfrontier.Boolean b = blockingFrontier.getActive(builder.build());
