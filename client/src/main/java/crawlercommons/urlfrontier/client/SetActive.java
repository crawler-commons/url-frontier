...
public class SetActive implements Runnable {
	...
	@Parameters(defaultValue = "true", paramLabel = "BOOLEAN", description = "whether the frontier should return URLs or not")
	...
	public void run() {
		...
		crawlercommons.urlfrontier.Urlfrontier.Boolean.Builder builder = crawlercommons.urlfrontier.Urlfrontier.Boolean
				.newBuilder();
