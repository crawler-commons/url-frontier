...
@Command(
        name = "GetURLs",
        description = "Get URLs from a Frontier and display in the standard output")
public class GetURLs implements Runnable {
    ...
    @Option(
            ...
            required = false,
            paramLabel = "INT",
            description = "delay before the URLs can be eligible for sending again")
    private int delay;
    ...
    @Option(
            ...
            required = false,
            paramLabel = "INT",
            description = "max URLs to return per queue")
    private int maxUrls;
    ...
    public void run() {
        ...
        Builder request =
                GetParams.newBuilder()
                        .setMaxUrlsPerQueue(maxUrls)
                        .setDelayRequestable(delay)
